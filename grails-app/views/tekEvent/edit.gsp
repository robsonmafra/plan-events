...
<%@ page import="plan.events.TekEvent" %>
<html>
    <head>
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: tekEventInstance, field: 'organizer', 'errors')}">
                                    <g:select name="organizer.id" from="${plan.events.TekUser.list()}" optionKey="id" value="${tekEventInstance?.organizer?.id}"  />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: tekEventInstance, field: 'volunteers', 'errors')}">
                                    <g:select name="volunteers" from="${plan.events.TekUser.list()}" multiple="yes" optionKey="id" size="5" value="${tekEventInstance?.volunteers*.id}" />
                                </td>
                            </tr>
...
<g:link controller="sponsorship" action="create" params="['tekEvent.id': tekEventInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'sponsorship.label', default: 'Sponsorship')])}</g:link>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: tekEventInstance, field: 'tasks', 'errors')}">
                                    <g:select name="tasks" from="${plan.events.Task.list()}" multiple="yes" optionKey="id" size="5" value="${tekEventInstance?.tasks*.id}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: tekEventInstance, field: 'messages', 'errors')}">
                                    <g:select name="messages" from="${plan.events.Message.list()}" multiple="yes" optionKey="id" size="5" value="${tekEventInstance?.messages*.id}" />
                                </td>
                            </tr>
